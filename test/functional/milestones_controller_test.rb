...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { description: @milestone.description, id: @milestone.id, import: @milestone.import, number: @milestone.number }
    end
  ...
  test "should update milestone" do
    put :update, id: @milestone, milestone: { description: @milestone.description, id: @milestone.id, import: @milestone.import, number: @milestone.number }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
